...
class SalaireForm(FlaskForm):
    ...
    profession_choix = ["Affaires, finance et administration [1]",
                        ...
                        "Cadres intermédiaires des métiers, des transports, de la production et des services "
                        "d'utilité publique [07-09]",
                        "Cadres intermédiaires spécialisés/cadres intermédiaires spécialisées [01-05]",
                        "Cadres supérieurs/cadres supérieures [00]",
                        "Dispensateurs/dispensatrices de soins et personnel de soutien en enseignement, en droit et "
                        "en protection publique [44]",
                        ...
                        "Opérateurs/opératrices de machinerie reliée à la transformation et à la fabrication et autre "
                        "personnel assimilé [94]",
                        ...
                        "Personnel de soutien des métiers, manoeuvres et aides d'entreprise en construction et autre "
                        "personnel assimilé [76]",
                        ...
                        "Personnel de supervision dans la transformation, la fabrication et les services d'utilité "
                        "publique et opérateurs/opératrices de poste central de contrôle [92]",
                        ...
                        "Personnel en opération d'équipement de transport et de machinerie lourde et autre personnel "
                        "assimilé à l'entretien [75]",
                        ...
                        "Représentants/représentantes de services et autre personnel de services à la clientèle et "
                        "personnalisés [65]",
                        ...
                        "Superviseurs/superviseures et métiers techniques dans les ressources naturelles, "
                        "l'agriculture et la production connexe [82]",
                        "Vente et services [6]"
                        ]
